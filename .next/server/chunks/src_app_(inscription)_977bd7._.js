...
"[project]/src/app/(inscription)/api.js [app-ssr] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_require_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, l: __turbopack_load__, j: __turbopack_dynamic__, p: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
const submitInscriptionData = async (data)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${API_BASE_URL}/registration`, {
            first_name: data.nom,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$inscription$292f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/(inscription)/api.js [app-ssr] (ecmascript)");
"__TURBOPACK__ecmascript__hoisting__location__";
"use client";
;
;
...
const InscriptionPage3 = ()=>{
    ...
    const handleSubmit = async ()=>{
        try {
            const formData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$inscription$292f$components$2f$Store$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useInscriptionStore"]((state)=>state.form);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$inscription$292f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["submitInscriptionData"](formData);
...
//# sourceMappingURL=src_app_(inscription)_977bd7._.js.map