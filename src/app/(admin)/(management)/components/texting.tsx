...
import { AlertDialogDemo } from "./deg"
...
export const columns: ColumnDef<Payment>[] = [
    ...
    ////////////////////////////////////
    {
        ...
        header: () => {
            return (
                <div className="text-black font-semibold">Aéroport</div>
            )
        },
    ...
    ///////////////////////////////////////
    {
        ...
        header: () => {
            return (
                <div className="text-black font-semibold">Date de départ</div>
            )
        },
    ...
    //////////////////////////////////////////////
    {
        ...
        header: () => {
            return (
                <div className="text-black font-semibold">Date d'arrivée</div>
            )
        },
    ...
    /////////////////////////////////////////////
    {
        ...
        header: () => {
            return (
                <div className="text-black font-semibold mr-3">Nombre de place</div>
            )
        },
            ...
            return (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                            onClick={() => navigator.clipboard.writeText(payment.N)}
                        >
                            Copy  ID
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />
