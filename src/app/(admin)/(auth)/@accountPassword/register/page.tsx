...
// schema
import { registerSchema2 } from "@/app/(admin)/(auth)/constants/schemas";
import { zodResolver } from "@hookform/resolvers/zod";
import { z } from "zod";
import PasswordInput from "@/app/(admin)/(auth)/components/password-input";
import { useRegisterStore } from "@/app/(admin)/(auth)/stores/register-store";
import { motion } from "framer-motion";
import { cn } from "@/lib/utils";
import { MultiStepKeys, useMultiStep } from "@/app/(admin)/(auth)/hooks/use-mutli-step-register";
